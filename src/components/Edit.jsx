    ...
    return(
        ...
        <div>
            ...
            <div>    
                ...
                <input type='text' value = {specialty} onChange = {(e)=>setspecialty(e.target.value.toLocaleLowerCase())} />
            </div>
            <div>    
                <label> direccion:</label>
                <input type='text'value = {street} onChange = {(e)=>setstreet(e.target.value.toLocaleLowerCase())} />
                <input type='text'value = {number} onChange = {(e)=>setnumber(e.target.value)} />
                <input type='text' value = {city}  onChange = {(e)=>setcity(e.target.value.toLocaleLowerCase())}/>
            </div>
