...
return(
   <div >
      ...
      <div className='prestador'>
         ...
         <h4>{search} en el plan {plan} , para realizar otra busqueda diríjase a <Link className='home' to={'/search'}>Home</Link></h4>
      ...
      <div>
         ...
         <table className='listadoMedicos responsive-table'>
            ...
            {todos.map((medico)=><tr key={medico.id}><td className='datos'>{medico.name}</td><td className='datos'>{medico.lastname}</td><td className='datos'>{medico.specialty}</td><td className='datos'>{medico.street}</td><td className='datos'>{medico.number}</td><td className='datos'>{medico.city}</td><td><img src={medico.url} alt="imagen_perfil" /></td>{/*<td>{medico.address.street} {medico.address.number } {medico.address.city }</td>*/}  </tr> )} 
